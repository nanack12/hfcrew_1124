...
def col5_about():
    ...
    st.markdown(f'<div style="display: flex; align-items: center;"><img src="{imgPath1}" style="width: 180px; height:80px; margin-right:20px; margin-bottom:20px;">', unsafe_allow_html=True)
